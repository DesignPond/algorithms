        ...
        <div class="uk-grid-large" data-uk-grid>
            ...
            <div class="uk-width-1-1 uk-width-expand@m">
                <article class="uk-article">
                    ...
                    <p class="uk-text-lead uk-text-muted">This document covers the setup and options of theme feature described in
                        the doc title</p>
                    <div class="uk-article-meta uk-margin-top uk-margin-medium-bottom uk-flex uk-flex-middle">
                        <img class="uk-border-circle avatar" src="img/avatar-sara.png"
                             alt="Sara Galen">
                        <div>
                            Written by
                            <span>Sara Galen</span><br>
                    ...
                    <div class="article-content link-primary">
                        ...
                        <figure data-uk-lightbox="animation: slide">
                            <a class="uk-inline" href="img/success.png" data-caption="Image in lightbox">
                                <img src="img/success.png" alt="Alt for image">
                    ...
                    <div class="uk-margin-large-top paginate-post">
                        <div class="uk-child-width-expand@s uk-grid-large" data-uk-grid>
                            ...
                            <div>
                                ...
                                <div class="uk-text-right"><a class="remove-underline hvr-forward" href="doc.html">Next →</a></div>
                            </div>
                        </div>
                    </div>
